...
public void testGen()
{
   ...
   jap.addAnnotationProcessor("edu.brown.cs.ivy.jannot.JannotTestGeneratingAnnotationProcessor");
...
private JannotProject setupTestProject()
{
   ...
   JcompSource src = new LocalSource("/pro/ivy/jannot/src/JannotTestMutableClass.java");
   srcs.add(src);
   JcompProject jp = ctrl.getProject("/pro/ivy/java",srcs);
   jp.resolve();
