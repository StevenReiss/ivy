...
public class JannotTreeJCTypeCast extends JannotTreeJCExpression 
...
JannotTreeJCTypeCast(CastExpression n) 
{
   super(n);
}
...
private CastExpression getNode()
{
   return (CastExpression) ast_node;
}
...
}       // end of class JannotTreeJCTypeCast




/* end of JannotTreeJCTypeCast.java */
