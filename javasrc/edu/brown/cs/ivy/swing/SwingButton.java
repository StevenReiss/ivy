...
public SwingButton(IvyI18N intl)
{
   this(null,null,intl);
}
...
public SwingButton(String text,Icon icon,IvyI18N intl)
{
...
public SwingButton(Action a,IvyI18N intl)
{
   super(a);
   i18n_map = intl;
   if (intl != null) {
...
public SwingButton(Icon icn)
{
   super(icn);
   i18n_map = null;
}

public SwingButton(Icon icn,IvyI18N intl)
{
   super(icn);
   i18n_map = intl;
}
...
}       // end of class SwingButton




/* end of SwingButton.java */
